...
const RentSearch = () => {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full flex flex-col items-start justify-center px-4 md:px-12 py-12 gap-8 md:gap-16">
        <div className="flex-1 flex flex-col items-center md:items-start text-center md:text-left max-w-xl mx-auto md:mx-0">
          <h1 className="text-5xl md:text-7xl font-bold mb-4 leading-tight text-yellow-400">
            TERRA
            <br />
            <span className="text-white">RENT CAR</span>
          </h1>
          <p className="text-xl md:text-2xl text-yellow-400 mb-2 font-semibold">
            {t("hero.slogan")}
          </p>
          ...
          {/* Новый календарный компонент поиска аренды */}
          <div className="mb-8 w-full">
            <RentSearchCalendar onSearch={undefined} />
          </div>
          <div className="flex flex-col sm:flex-row gap-4 mb-6 w-full md:w-auto justify-center md:justify-start">
            <Button
              size="lg"
